...
The Blog app is a quintessential representation of a typical blog website. It serves as a fully functional platform that displays a curated list of posts while providing readers with the means to engage actively through features like comments and post liking.
...
```sh
  cd my-folder
  gh repo clone https://github.com/Kccendana/blog.git
```
...
Feel free to check the <a href="https://github.com/Kccendana/blog/issues">Issues</a>.
